...
def create_efficient_det(input_shape=(800, 700, 20), kr=tf.keras.regularizers.l2(1e-4), ki='he_normal', data_format=None):
    ...
    with tf.name_scope('Concatenation'):
        ...
        b1_out, b2_out, b3_out = _build_BiFPN_full_res(b1_out, b2_out, b3_out, filters=bifpn_filters, max_relu_val=None, weighted=True, excite=True)
        b1_out, b2_out, b3_out = _build_BiFPN_full_res(b1_out, b2_out, b3_out, filters=bifpn_filters, max_relu_val=None, weighted=True, excite=True)
