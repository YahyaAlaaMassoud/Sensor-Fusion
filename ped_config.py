...
configs = {
    ...
    'mean_height': 1.52,
    'mean_altitude': 1.71,
    'ckpts_dir': 'ckpts_biFPN_ped',
    'training_target': PEDESTRIANS_ONLY, # on of the enums {ALL_VEHICLES, CARS_ONLY, PEDESTRIANS_ONLY, CYCLIST_ONLY}
    ...
    'optimizer': Adam,
    'experiment_name': '/pixor_bifpn_ped_',
    'start_epoch': 0,
    'use_pretrained': False,
    'last_ckpt_json': 'outputs/ckpts_biFPN_ped/pixor_bifpn_ped__epoch_7.json', # absolute path
    'last_ckpt_h5': 'outputs/ckpts_biFPN_ped/pixor_bifpn_ped__epoch_7.h5', # absolute path
